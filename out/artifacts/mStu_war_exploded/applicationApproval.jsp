...
<table border="1" cellspacing="0" align="center" class="con-b">
    ...
    <c:forEach items="${arr}" var="ApplicationApproval" begin="${startRecord}" end="${endRecord +10000}">
        ...
        <tr>
            ...
            <c:if test="${session_person.getUserIdentify()==1}">
                <td>
                    <button type="button" onclick="agreeApplication('${ApplicationApproval.studentId}','${ApplicationApproval.courseId}','${session_person.getUserAccount()}','${role}' ,'${ApplicationApproval.instructorIsFinish}','${ApplicationApproval.supervisorIsFinish}','${ApplicationApproval.instructorApproval}')">
                        同意
                    </button>
                    <button type="button" onclick="rejectApplication('${ApplicationApproval.studentId}','${ApplicationApproval.courseId}','${session_person.getUserAccount()}','${role}','${ApplicationApproval.instructorIsFinish}','${ApplicationApproval.supervisorIsFinish}')">
                        驳回
                    </button>
                </td>
            ...
            <c:if test="${session_person.getUserIdentify()==0}">
    <td>
        <button type="button" onclick="confirmApproval('${ApplicationApproval.studentId}','${ApplicationApproval.courseId}','${ApplicationApproval.instructorIsFinish}','${ApplicationApproval.supervisorIsFinish}')">
        确认
        </button>
    </td>
            </c:if>
