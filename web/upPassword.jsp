        ...
        <form method="post" action="common.action?action=sureUpPassword" onsubmit="return checkThisFile()">
            <table class="table table-striped table-bordered table-hover datatable">
                ...
                <tr height="15px">
                    ...
                    <th style="text-align: center;"><input name="userPassword" id="userPassword" type="password"
                                                           width="400px"
                                                           height="26px"
                ...
                <tr style="width: 500px">
                    ...
                    <th style="text-align: center;width: 70%"><input id="a" type="password" width="400px" height="26px"
