    ...
    <c:forEach items="${arr}" var="person" begin="${startRecord}" end="${endRecord +10000}">
        ...
        <tr>
            ...
            <c:if test="${session_person.getUserIdentify()==2}">
                <td>
                    <img src="del.png"
                         onclick="delThisPerson('${person.getUserAccount()}','${person.getUserIdentify()}')">
                </td>
            ...
            <c:if test="${session_person.getUserIdentify()!=0}">
                <td>
                    <c:if test="${session_person.getUserIdentify()==1}">
                        <img style="width: 40px;height: 40px" src="detail.jpg"
                             onclick="detailTask('${person.getUserAccount()}')">
            ...
            <c:if test="${session_person.getUserIdentify()==0}">
                <td><img style="width:40px;height: 40px" onclick="addTeacher('${person.getUserAccount()}')"
                         src="addTeacher.png"></td>
            </c:if>
        </tr>
